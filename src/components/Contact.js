  ...
  return (
    <div className="container">
        <div className="row">
            ...
            <form className="htmlForm my-3" onSubmit={submit }>
                <p className='text-secondary text-uppercase'>TELL US ABOUT YOUR PROJECT AND GOALS.</p>
                    <div className="mb-3 input-field">
                        <input type="text" id="name" className="text-box" placeholder=" " value={name} onChange={(e)=>{setName(e.target.value)}}/>
                    ...
                    <div className="mb-3 input-field">
                        <input type="email" id="email" className="text-box" placeholder=" " value={email} onChange={(e)=>{setEmail(e.target.value)}}/>
